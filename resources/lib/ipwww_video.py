...
def ListLive():
    channel_list = [
        ...
        ('bbc_two_england',         'bbc_two_england',           'BBC Two England',          ),
        ('bbc_one_cambridge',       'bbc_one_cambridge',         'BBC One Cambridge',        ),
        ('bbc_one_channel_islands', 'bbc_one_channel_islands',   'BBC One Channel Islands',  ),
        ('bbc_one_east',            'bbc_one_east',              'BBC One East',             ),
        ('bbc_one_east_midlands',   'bbc_one_east_midlands',     'BBC One East Midlands',    ),
        ('bbc_one_east_yorkshire',  'bbc_one_east_yorkshire',    'BBC One East Yorkshire',   ),
        ('bbc_one_north_east',      'bbc_one_north_east',        'BBC One North East',       ),
        ('bbc_one_north_west',      'bbc_one_north_west',        'BBC One North West',       ),
        ('bbc_one_oxford',          'bbc_one_oxford',            'BBC One Oxford',           ),
        ('bbc_one_south',           'bbc_one_south',             'BBC One South',            ),
        ('bbc_one_south_east',      'bbc_one_south_east',        'BBC One South East',       ),
        ('bbc_one_west',            'bbc_one_west',              'BBC One West',             ),
        ('bbc_one_west_midlands',   'bbc_one_west_midlands',     'BBC One West Midlands',    ),
        ('bbc_one_yorks',           'bbc_one_yorks',             'BBC One Yorks',            ),
    ]
